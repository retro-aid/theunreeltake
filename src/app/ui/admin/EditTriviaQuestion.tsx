...
export function EditTriviaQuestion({ opened, onCloseAction }: { opened: boolean, onCloseAction: () => void })
{
  ...
  return (
    <Modal opened={opened} onClose={handleClose} title={isSuccess ? "" : "Edit a trivia question"} centered radius="md">
      {isSuccess ? (
