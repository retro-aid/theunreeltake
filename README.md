...
<p>The Unreel team is a group of like-minded friends who are passionate authors, filmmakers and moviegoers that enjoy sharing their experiences. Their hope is that anyone who visits the website will share in their passion and is able to find a review that they can connect with.</p>
<h3>The Problem</h3>
<p>The Product Owner needs a blog posting website that supports a publicly viewable frontend and a private, invitation-only, backend.</p>
<h3>The Solution</h3>
<h4>Frontend</h4>
<p>Our frontend solution implements a public home route complete with a searchable catalog, an about page, and media request form.</p>
<h4>Backend</h4>
...
<ul>
  ...
  <li><a target="_blank" href="https://icons8.com/icon/bzf0DqjXFHIW/react">React</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a></li>
  <li>Mantime Website</li>
  <li>Better Auth Website</li>
  <li>Prisma Website</li>
  <li>Day.js Website</li>
  <li>Zod Website</li>
  <li><a target="_blank" href="https://icons8.com/icon/24895/npm">NPM</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a></li>
  <li>Vercel Website</li>
  <li>Neon Website</li>
  <li>ResendWebsite</li>
  <li><a target="_blank" href="https://icons8.com/icon/121601/visual-studio">Visual Studio</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a></li>
  <li><a target="_blank" href="https://icons8.com/icon/62856/github">github logo</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a></li>
</ul>
